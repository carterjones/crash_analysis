...
psexec \\192.168.91.128 -u %username% -p %password% -w C:\fuzzing_tools -i C:\python27\python.exe C:\fuzzing_tools\triage.py "C:\Program Files\VideoLAN\VLC\vlc.exe" C:\minifuzz\crashes